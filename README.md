...
To initialize simple model with encoder-decoder architecture ```ForecasterBase``` class should be called:
```
...
To operate separately with encoder and decoder parts of model they can be called from model:
```
